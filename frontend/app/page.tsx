  ...
  return (
    <div className="h-full">
      <div className="relative h-full">
        <div className="absolute top-[40%] md:top-[30%] left-[50%] translate-x-[-50%] translate-y-[-50%]w-fit z-20 text-gray font-bold mx-auto flex flex-col gap-[30px] lg:gap-[20px]">
