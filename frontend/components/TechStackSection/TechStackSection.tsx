    ...
    <div className="my-[5px] md:my-[16px]">
      {techStackData.map((techStack, idx) => {
        ...
        return (
          ...
          >
            <h1 className="my-[5px] font-bold w-fit md:mx-auto">{type}</h1>
            <div className="flex flex-wrap gap-2 items-center md:justify-center">
              {data.map((techData, techIdx) => {
                ...
                return (
                  <div
                    key={techIdx}
                    className="relative w-14 md:w-16 h-14 md:h-16 p-[50x] border-box hover:scale-110 hover:z-10 transition-all duration-75 bg-white cursor-pointer"
                  >
                    <div
